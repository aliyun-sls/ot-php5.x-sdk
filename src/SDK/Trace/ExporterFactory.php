...
class ExporterFactory
{
    ...
    public function __construct($serviceName = self::DEFAULT_SERVICE_NAME, $parser = null)
    {
        $this->serviceName = $serviceName;
        $this->parser = isset($parser) ? $parser : Parser::create();
    }
     ...
     */
    public function fromConnectionString(string $exporterDsn)
    {
    ...
    private function resolveServiceName(DsnInterface $dsn)
    {
        $result = self::getOptionFromDsn($dsn, 'serviceName');
        return isset($result) ? self::getOptionFromDsn($dsn, 'serviceName') : $this->serviceName;
    }

    private static function getOptionFromDsn(DsnInterface $dsn, string $parameter)
    {
    ...
    private static function buildExporter(string $protocol, string $endpoint = null, string $name = null, $args = null)
    {
    ...
    private static function validateProtocol(string $protocol)
    {
    ...
    private static function normalizeProtocol(string $scheme)
    {
