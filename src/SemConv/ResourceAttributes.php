...
interface ResourceAttributes
{
     ...
     * @example Chrome 99
     */
    const BROWSER_BRANDS = 'browser.brands';
     ...
     * @example Android
     */
    const BROWSER_PLATFORM = 'browser.platform';
     ...
     */
    const BROWSER_USER_AGENT = 'browser.user_agent';
     ...
     */
    const AWS_ECS_LAUNCHTYPE = 'aws.ecs.launchtype';
     ...
     */
    const AWS_ECS_TASK_ARN = 'aws.ecs.task.arn';
     ...
     */
    const AWS_ECS_TASK_FAMILY = 'aws.ecs.task.family';
     ...
     * @example 26
     */
    const AWS_ECS_TASK_REVISION = 'aws.ecs.task.revision';
     ...
     * @example arn:aws:ecs:us-west-2:123456789123:cluster/my-cluster
     */
    const AWS_EKS_CLUSTER_ARN = 'aws.eks.cluster.arn';
     ...
     */
    const AWS_LOG_GROUP_NAMES = 'aws.log.group.names';
     ...
     */
    const AWS_LOG_GROUP_ARNS = 'aws.log.group.arns';
     ...
     */
    const AWS_LOG_STREAM_NAMES = 'aws.log.stream.names';
     ...
     */
    const AWS_LOG_STREAM_ARNS = 'aws.log.stream.arns';
     ...
     * @example 0.1
     */
    const CONTAINER_IMAGE_TAG = 'container.image.tag';
     ...
     */
    const FAAS_VERSION = 'faas.version';
     ...
     * @example 128
     */
    const FAAS_MAX_MEMORY = 'faas.max_memory';
     ...
     */
    const HOST_TYPE = 'host.type';

    /**
     * The CPU architecture the host system is running on.
     */
    const HOST_ARCH = 'host.arch';
     ...
     */
    const HOST_IMAGE_NAME = 'host.image.name';
     ...
     */
    const HOST_IMAGE_ID = 'host.image.id';
     ...
     * @example 0.1
     */
    const HOST_IMAGE_VERSION = 'host.image.version';
     ...
     */
    const K8S_CLUSTER_NAME = 'k8s.cluster.name';
     ...
     */
    const K8S_NODE_UID = 'k8s.node.uid';
     ...
     * @example redis
     */
    const K8S_CONTAINER_NAME = 'k8s.container.name';
     ...
     * @example 2
     */
    const K8S_CONTAINER_RESTART_COUNT = 'k8s.container.restart_count';
     ...
     * @example 275ecb36-5aa8-4c2a-9c47-d8bb681b9aff
     */
    const K8S_REPLICASET_UID = 'k8s.replicaset.uid';
     ...
     * @example opentelemetry
     */
    const K8S_REPLICASET_NAME = 'k8s.replicaset.name';
     ...
     * @example 275ecb36-5aa8-4c2a-9c47-d8bb681b9aff
     */
    const K8S_DEPLOYMENT_UID = 'k8s.deployment.uid';
     ...
     * @example 275ecb36-5aa8-4c2a-9c47-d8bb681b9aff
     */
    const K8S_STATEFULSET_UID = 'k8s.statefulset.uid';
     ...
     * @example opentelemetry
     */
    const K8S_STATEFULSET_NAME = 'k8s.statefulset.name';
     ...
     * @example 275ecb36-5aa8-4c2a-9c47-d8bb681b9aff
     */
    const K8S_DAEMONSET_UID = 'k8s.daemonset.uid';
     ...
     * @example opentelemetry
     */
    const K8S_DAEMONSET_NAME = 'k8s.daemonset.name';
     ...
     * @example opentelemetry
     */
    const K8S_JOB_NAME = 'k8s.job.name';
     ...
     * @example 275ecb36-5aa8-4c2a-9c47-d8bb681b9aff
     */
    const K8S_CRONJOB_UID = 'k8s.cronjob.uid';
     ...
     * @example opentelemetry
     */
    const K8S_CRONJOB_NAME = 'k8s.cronjob.name';
     ...
     */
    const OS_DESCRIPTION = 'os.description';
     ...
     * @example otelcol
     */
    const PROCESS_EXECUTABLE_NAME = 'process.executable.name';
     ...
     */
    const PROCESS_EXECUTABLE_PATH = 'process.executable.path';
     ...
     * @example cmd/otelcol
     */
    const PROCESS_COMMAND = 'process.command';
     ...
     */
    const PROCESS_COMMAND_LINE = 'process.command_line';
     ...
     */
    const PROCESS_COMMAND_ARGS = 'process.command_args';
     ...
     */
    const PROCESS_RUNTIME_NAME = 'process.runtime.name';
     ...
     * @example 14.0.2
     */
    const PROCESS_RUNTIME_VERSION = 'process.runtime.version';
     ...
     */
    const PROCESS_RUNTIME_DESCRIPTION = 'process.runtime.description';
     ...
     * @example opentelemetry
     */
    const TELEMETRY_SDK_NAME = 'telemetry.sdk.name';

    /**
     * The language of the telemetry SDK.
     */
    const TELEMETRY_SDK_LANGUAGE = 'telemetry.sdk.language';
     ...
     * @example 1.2.3
     */
    const TELEMETRY_SDK_VERSION = 'telemetry.sdk.version';
     ...
     * @example 1.2.3
     */
    const TELEMETRY_AUTO_VERSION = 'telemetry.auto.version';
     ...
     * @example WildFly
     */
    const WEBENGINE_NAME = 'webengine.name';
     ...
     * @example 21.0.0
     */
    const WEBENGINE_VERSION = 'webengine.version';
     ...
     */
    const WEBENGINE_DESCRIPTION = 'webengine.description';
}
